...
#SBATCH --output=Cellranger_Pos24hpi_1_ATH_Read_Only_%j.out      # Standard output log
...
/projects/intro2gds/Razan_2024/scRNA_Seq_Arab/Refdata_Arab/cellranger-8.0.1/cellranger count \
    --id=Mapping_Pos24hpi_2_scRNAseq_11_2_24_ATH_Read_Only \
    --transcriptome=/projects/intro2gds/Razan_2024/scRNA_Seq_Arab/Refdata_Arab/ATH_genome_10_3_24 \
    --fastqs=/projects/intro2gds/Razan_2024/scRNA_Seq_Arab/10X_Pos24hpi_Bam_file_Barcode_File/Pos24hpi_2/11_1_24_10X/plant_fastq_output_20241101_215749/10X_Combined_Pathogene_Mapping_Pos24hpi_2_scRNAseq_10_28_24_0_1_22GH3VLT4/Combined_Files_Fastq \
    --sample=Pos24hpi2 \
    --force-cells=8000 \
    --create-bam=true
